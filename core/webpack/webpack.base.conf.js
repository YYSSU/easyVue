...
module.exports = {
    ...
    resolve: {
        ...
        alias: {
            ...
            'evAll$': util.resolve('core/base/all.js'),
            'evOriginal$': util.resolve('core/base/original.js'),
            'evPacking$': util.resolve('core/base/pack.js'),
    ...
    module: {
        rules: [
            ...
            },
            {
                ...
                include: [util.resolve('core'), util.resolve('src'), util.resolve('test'), util.resolve('node_modules/webpack-dev-server/client')]
            },
            {
                test: /\.svg$/,
